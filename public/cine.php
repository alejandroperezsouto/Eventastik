...
$sql = "SELECT * FROM eventos WHERE (tipo = 'cine')"?>
<?
$result = "";
...
$sql = "SELECT * FROM eventos WHERE (tipo = 'cine') AND (titulo LIKE '%$busqueda%' OR descripcion LIKE '%$busqueda%' OR localidad LIKE '%$busqueda%')";

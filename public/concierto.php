...
$sql = "SELECT * FROM eventos WHERE (tipo = 'concierto')"?>
<?
$result = "";
...
$sql = "SELECT * FROM eventos WHERE (tipo = 'concierto') AND (titulo LIKE '%$busqueda%' OR descripcion LIKE '%$busqueda%' OR localidad LIKE '%$busqueda%')";
  
}
?>

<a href="index.php"><button class="inicio">Inicio</button></a>
  <form action="concierto.php" method="post">
